...
static void custom_fsp_config(FSP_S_CONFIG *params)
{
	params->C1e = 1;
	params->EnableAllThermalFunctions = 1;
	params->ThermalMonitor = 1;
	params->CpuPcieResizableBarSupport = 1;
	params->EnableHwpScalabilityTracking = 1;
	params->HwpInterruptControl = 1;
	params->EnableItbm = 1;
	params->AesEnable = 1;
}
